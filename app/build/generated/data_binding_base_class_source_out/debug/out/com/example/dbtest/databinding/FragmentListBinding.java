...
public final class FragmentListBinding implements ViewBinding {
  ...
  private FragmentListBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView RecylerView,
      @NonNull ImageButton btnBack, @NonNull FloatingActionButton floatingActionButton) {
  ...
  public static FragmentListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentListBinding((ConstraintLayout) rootView, RecylerView, btnBack,
